...
<head>
    ...
    <link href="vendor/owlcarousel/owl.carousel.min.css" type="text/css" rel="stylesheet" />
    <link href="vendor/fancybox/jquery.fancybox.min.css" type="text/css" rel="stylesheet" />
    ...
    <div class="container_ui">
        <div class="flex flex-between">
            <div class="logo_place">
                <a href="/html/"><? include 'img/ico/Logo.svg'?></a>
            </div>
            ...
            <div class="menu_t flex flex-a-center mob_hide">
                <nav>
                    <ul class="flex flex-center menu">
                        <li class="part"><a href="news.php">Новости</a></li>
                        <li class="part"><a href="team.php">Команда</a></li>
                        <li class="part"><a href="">Клуб</a></li>
                        <li class="part"><a href="photos.php">Медиа</a></li>
                        <li class="part"><a href="about.php">Волей град</a></li>
                    </ul>
                </nav>
            </div>
            <div class="burger_place flex flex-a-center">
                <div class="burger js_menu">
                    <? include 'img/ico/burger.svg'?>
                    <? include 'img/ico/close.svg'?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="menu_place">
        <ul class="menu_list flex flex-between">
            <li class="parent_item_list">
                ...
                <ul class="child_list">
                    <li><a href="team.php">Игроки</a></li>
                    <li><a href="team.php">Тренерский штаб</a></li>
                    <li><a href="calendar.php">Календарь</a></li>
                    <li><a href="tournament.php">Турнирная таблица</a></li>
                </ul>
            </li>
            <li class="parent_item_list">
            ...
            <li class="parent_item_list">
                ...
                <ul class="child_list">
                    ...
                    <li><a href="sponsors.php">Спонсоры и партнеры</a></li>
