...
<h1>ИГРА "ДИНАМО-АНАПА" - "ДИНАМО"<br>
 </h1>
<h3 class="container_ui" style="text-align: center;"><a href="https://volley.ru/games/01J44APMDA9AMS1409NAAF04YH?t=glbtab-1" style="text-align: center; font-family: var(--ui-font-family-primary, var(--ui-font-family-helvetica)); font-size: 14px;" target="_blank" class="btn_link">Трансляция</a></h3>
 <?$APPLICATION->IncludeComponent(
	"custom:last.season",
	"",
	Array(
